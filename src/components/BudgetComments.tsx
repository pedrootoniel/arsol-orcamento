...
export function BudgetComments({ budgetId, isAdmin }: Props) {
  ...
  return (
    <div className="h-full flex flex-col bg-slate-50">
          ...
          comments.map((comment) => (
            ...
            >
              ...
              >
                ...
                <p className={comment.is_admin_reply ? 'text-white' : 'text-slate-700'}>
                  {comment.content}
                </p>
              </div>
            </div>
      ...
      <form onSubmit={sendComment} className="p-4 bg-white border-t border-slate-200">
          ...
          <input
            ...
            placeholder={
              isAdmin
                ...
                : 'Digite sua dúvida ou solicitação de ajuste...'
            }
